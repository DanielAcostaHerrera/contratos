...
@Module({
  imports:[TypeOrmModule.forFeature([
    SuplementoResumen
  ]),EjecutivoModule,MonedaModule,AgenciasAseguradorasModule,CompaniasNavierasModule,NegociacionResumenModule,PaisesModule,IncotermModule,FormasEntregaModule],
